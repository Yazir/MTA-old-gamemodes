...
modShops[ 1 ].veh = false
modShops[ 1 ].marker = createMarker( 2499.6159, -1779.8135, 12.8, "cylinder", 3, 255, 0, 0, 100 )
modShops[ 1 ].name = "LS Modshop."
--createBlipAttachedTo( modShops[ 3 ].marker, 27, 2, 0,0,0,255, 0, 150 )
createBlipAttachedTo( modShops[ 1 ].marker, 27, 2, 0,0,0,255, 0, 300 );

if exports.kp_safezones then exports.kp_safezones:createSafezone( 2499.6159, -1779.8135, 35 ) end
